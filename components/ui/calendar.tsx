...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  ...
  const designClasses = {
    default: {
      ...
      nav_button: "h-7 w-7 rounded-md",
    },
    ios: {
      day: "h-9 w-9 rounded-full",
      nav_button: "h-7 w-7 rounded-full",
    },
    material: {
      day: "h-10 w-10 rounded-full",
      nav_button: "h-8 w-8 rounded-full",
    },
  }
    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          designClasses[designSystem].nav_button,
        ),
        ...
        day: cn(
          ...
          designClasses[designSystem].day,
        ),
